        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FisrtName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TSCs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TSCs_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TSCs_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TSCs_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TSCs_ClassId",
                table: "TSCs",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_TSCs_SubjectId",
                table: "TSCs",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_TSCs_TeacherId",
                table: "TSCs",
                column: "TeacherId");
        }
